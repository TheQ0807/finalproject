...
<nav class="navbar navbar-static-top navbar-default">
	<div class="container">
		<c:if test="${loginEmployee.department.id eq 'DEPT-HR' }">
		...
		<c:if test="${loginEmployee.department.id eq 'DEPT-FIN' }">
			<div class="navbar-header ">
			<a class="navbar-brand" href="/manage/finance/main.do"><strong>재무</strong></a>
		</div>
		<ul class="nav navbar-nav">
			<li class="active"><a href="/manage/finance/main.do">메인 페이지</a></li>
			<li class="dropdown">
				<a href="/manage/finance/payAnalysis.do" class="dropdown-toggle" data-toggle="dropdown">수입/지출 분석<span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="/manage/finance/payAnalysis.do">전체 수입/지출 현황</a></li>
					<li><a href="#">물류 매출 현황</a></li>
					<li><a href="#">인사 수입/지출 현황</a></li>
					<li><a href="#">서비스 관련 현황</a></li>
				</ul>
			</li>
			<li><a href="#">월급 지급</a></li>
		</ul>
		</c:if>
		<c:if test="${loginEmployee.department.id eq 'DEPT-SC' }">
			<div class="navbar-header ">
		...
		<c:if test="${loginEmployee.department.id eq 'DEPT-ADMIN' }">
		<div class="navbar-header ">
			<a class="navbar-brand" href="#"><strong>운영팀</strong></a>
		</div>
		<ul class="nav navbar-nav">
			<li class=""><a href="/notice/employee/list.do"><strong>홈</strong></a></li>
			<li class="dropdown active"><a class="dropdown-toggle"
				data-toggle="dropdown" href="/notice/employee/list.do"><strong>공지사항 관리</strong><span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="/notice/employee/list.do">사내용</a></li>
					<li><a href="/notice/customer/list.do">고객용</a></li>
				</ul></li>
			<li><a href="/suggestion/list.do"><strong>건의사항 답변</strong></a></li>
