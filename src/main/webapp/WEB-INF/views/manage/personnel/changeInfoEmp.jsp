    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 well">
                <div class="row">
                    <div class="col-sm-9">
                        <form:form class="form-horizontal" id="change-form" action="changeInfoEmp.do" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="control-label col-sm-2">이름</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" readonly="readonly" value="${changeInfo.name }" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="phone" value="${changeInfo.phone }" />
                                </div>
                            </div>
                            <div class="form-group">
