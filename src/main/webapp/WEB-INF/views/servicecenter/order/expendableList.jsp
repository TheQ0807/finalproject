...
<script type="text/javascript">
	$(function(){
		...
		$.getJSON("/rest/getparts", {pageNo:1, divisionId:initDiv, categoryId:initCat, rows:8}).done(function(result){
			var html="";
		...
		$('.list-cat').on('click', function(e) {
		    ...
		    $.getJSON("/rest/getparts", {pageNo:pageNo, divisionId:0, categoryId:categoryId, rows:8}).done(function(result){
				var html="";
				if(result.parts.length!=0){
					$.each(result.parts, function(index, part){
						html += "<div class='single-item-box col-md-3'>"
