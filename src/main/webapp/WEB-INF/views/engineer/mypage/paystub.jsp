		...
		$.ajax({
			...
			success:function(data) {
				...
				var totalSalary = (data.employee.salary/12)- (data.employee.salary/12/10);
					...
					$('#table-div table:nth-child(2) tr:last td:first').text($.number(salary, ','));
					$('#table-div table:nth-child(2) tr:last td:last').text($.number(tax, ','));
					
					$('#table-div table:nth-child(3) tr td').text($.number(totalSalary, ','));
